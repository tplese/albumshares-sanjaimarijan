            ...
            if (this.s.download) {
                ...
                if (_src) {
                    ...
                    if (_src.includes('photos/fulls')) {
                        photosUrl = _src.replace('martinaidavorin_bucket/photos/fulls/', 'download/storage/v1/b/martinaidavorin_bucket/o/photos%2Ffulls%2F') + '?alt=media';
                    } else if (_src.includes('photos2/fulls')) {
                        photosUrl = _src.replace('martinaidavorin_bucket/photos2/fulls/', 'download/storage/v1/b/martinaidavorin_bucket/o/photos2%2Ffulls%2F') + '?alt=media';
                    };
